# Software-AES core firmware — not published yet

> **This directory is intentionally empty for now.**
> Its contents will be made public soon.

Firmware for the second RISC-V core running a byte-serial software AES, with the trigger fenced around the first-round S-box.
...
the Sw-RV firmware source and built images remain outside this repository.
...
| 💻 **Host and acquisition software** | [`../Python/`](../Python/) and [`../../Acquisition/`](../../Acquisition/) |
